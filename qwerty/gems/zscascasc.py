...
class zscascasc(MacroSpec):
    name: str = "zscascasc"
    projectName: str = "qwerty"
    category: str = "Transform"


    @dataclass(frozen=True)
    class zscascascProperties(MacroProperties):
    ...
    def apply(self, props: zscascascProperties) -> str:
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return zscascasc.zscascascProperties(
